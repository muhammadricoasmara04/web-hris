...
export function ProfileHeader() {
  ...
  return (
    <header className="fixed left-0 top-0 z-[500] flex w-full items-center justify-between p-4 px-6 pt-8 bg-transparent pointer-events-none">
      ...
      <button 
        className="pointer-events-auto relative flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-xl transition-all duration-300 active:scale-95 hover:bg-white/15 hover:border-white/30 shadow-[0_8px_32px_0_rgba(255,255,255,0.05),inset_0_2px_4px_rgba(255,255,255,0.2)]"
      >
